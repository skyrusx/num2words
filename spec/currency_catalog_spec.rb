...
RSpec.describe "currency catalog" do
  ...
  %w[ru en fr ar be bg bn cs da de el es et fa fi gu he hi hr hu id it ja kn ko kz lt lv ml mr ms nb nl pa pl pt ro sk sl sr sv sw ta te th tr uk ur].each do |locale|
