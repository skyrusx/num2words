...
module Num2words
  module Locales
    module MS
      ...
      FRACTIONS = I18n.t("num2words.fractions", locale: :ms)
      GRAMMAR = I18n.t("num2words.grammar", locale: :ms)

      DATE = I18n.t("num2words.date", locale: :ms)
      DATE_TEMPLATE = I18n.t("num2words.date.template", locale: :ms)
      TIME = I18n.t("num2words.time", locale: :ms)
      TIME_TEMPLATE = I18n.t("num2words.time.template", locale: :ms)
      DATETIME_TEMPLATE = I18n.t("num2words.datetime.template", locale: :ms)

      ORDINALS = I18n.t("num2words.numbers.ordinals", locale: :ms)
